        ...
        <Navbar collapseOnSelect expand="lg" style={{ background: '#D2E2D9' }}>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link className={styles.navButton} eventKey="about" onSelect={this.handleChange}>
                About
              </Nav.Link>
              <Nav.Link className={styles.navButton} eventKey="images" onSelect={this.handleChange}>
                Images
              </Nav.Link>
              <Nav.Link className={styles.navButton} eventKey="discussions" onSelect={this.handleChange}>
                Discussions
              </Nav.Link>
              <Nav.Link className={styles.navButton} eventKey="hypotheses" onSelect={this.handleChange}>
                Hypotheses
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
